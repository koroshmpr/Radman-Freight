...
<section class="container bg-info rounded-section margin-top z-2 overflow-hidden mb-5">
    <div class="row row-cols-1 row-cols-lg-3 justify-content-start px-lg-5 z-5">
        <?php
        $j = 0;
        $args = array(
            'post_type' => 'services',
